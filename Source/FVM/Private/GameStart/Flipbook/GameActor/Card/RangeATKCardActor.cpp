...
void ARangeATKCardActor::OnCardInitData(const FItemCard& NewBaseData)
{
	Super::OnCardInitData(NewBaseData);

	//初始化必要数据
	this->ItemCardRangeATK = this->GetCardDataObject()->GetCardRangeATKData(this->CardID);
	this->ItemCardRangeATK.Level = this->GetCardSourceData().Level;
	...
	this->SetCardData(this->ItemCardRangeATK);

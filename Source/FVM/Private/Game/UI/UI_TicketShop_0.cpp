...
UWidget* UUI_TicketShop_0::WidgetCreate_Init(const UItemLoadDataBlock* const _Data, int32 _Index)
{
	...
	//设置券的图标
	//_Grid->SetTicketHead(_Data->GetValuePtr<FItem_TicketPrice_Data>()->M_FItemPrice.M_TicketHeadTexture2DPath.ToString());
	//设置物品的头像
	//_Grid->SetItemHead(_Data->GetValuePtr<FItem_TicketPrice_Data>()->M_FItemPrice.M_ItemHeadTexture2DPath.ToString());
	//设置数据
	//_Grid->SetItemData(_Data->GetValue<FItem_TicketPrice_Data>().M_FItemPrice);
	//设置初始化
	_Grid->InitBase();
	//播放动画
	_Grid->Anim();
...
void UUI_TicketShop_0::WidgetRefresh_Update(const UItemLoadDataBlock* const _Data, int32 _Index, UWidget* _UWidget)
{
	//设置券的图标
	//Cast<UUI_TicketShopGrid>(_UWidget)->SetTicketHead(_Data->GetValuePtr<FItem_TicketPrice_Data>()->M_FItemPrice.M_TicketHeadTexture2DPath.ToString());
	//设置物品的头像
	//Cast<UUI_TicketShopGrid>(_UWidget)->SetItemHead(_Data->GetValuePtr<FItem_TicketPrice_Data>()->M_FItemPrice.M_ItemHeadTexture2DPath.ToString());
	//设置数据
	Cast<UUI_TicketShopGrid>(_UWidget)->SetItemData(_Data->GetValue<FItem_TicketPrice_Data>().M_FItemPrice);
	//设置初始化
...
void UUI_TicketShop_0::Init()
{
	...
	/*
	this->M_Ticket_UItemLoaderObject = NewObject<UItemLoaderObject>(this, TEXT("Ticket_UItemLoaderObject"));
	this->M_Ticket_UItemLoaderObject->InitWidget_First(this->M_ShopItemPanel, this->M_UScrollBox, 0.01f);
	this->M_Ticket_UItemLoaderObject->InitRange_Second(5, 4, 9999, 400.f, 170.f);
	this->M_Ticket_UItemLoaderObject->SetGridWidgetMargin(FVector2D(80.f, 0.f));
	this->M_Ticket_UItemLoaderObject->OnNew.BindUFunction(this, TEXT("WidgetCreate_Init"));
	this->M_Ticket_UItemLoaderObject->OnUpdate.BindUFunction(this, TEXT("WidgetRefresh_Update"));
	*/
}
...
void UUI_TicketShop_0::Cards()
{
	...
	this->M_Ticket_UItemLoaderObject->UpdateDatatable(this->M_Cards);
	this->M_Ticket_UItemLoaderObject->SetLoaderItemMaxCount(this->M_Cards.Num());
	this->M_Ticket_UItemLoaderObject->SetLoaderPage(0);
	this->M_Ticket_UItemLoaderObject->Execute();
}
...
void UUI_TicketShop_0::CardSkillbooks()
{
	...
	this->M_Ticket_UItemLoaderObject->UpdateDatatable(this->M_CardSkillbooks);
	this->M_Ticket_UItemLoaderObject->SetLoaderItemMaxCount(this->M_CardSkillbooks.Num());
	this->M_Ticket_UItemLoaderObject->SetLoaderPage(0);
	this->M_Ticket_UItemLoaderObject->Execute();
}
...
void UUI_TicketShop_0::CardChangedJobs()
{
	...
	this->M_Ticket_UItemLoaderObject->UpdateDatatable(this->M_CardChangedJobs);
	this->M_Ticket_UItemLoaderObject->SetLoaderItemMaxCount(this->M_CardChangedJobs.Num());
	this->M_Ticket_UItemLoaderObject->SetLoaderPage(0);
	this->M_Ticket_UItemLoaderObject->Execute();
}
...
void UUI_TicketShop_0::TicketShop_0_All()
{
	...
	this->M_Ticket_UItemLoaderObject->UpdateDatatable(this->M_All);
	this->M_Ticket_UItemLoaderObject->SetLoaderItemMaxCount(this->M_All.Num());
	this->M_Ticket_UItemLoaderObject->SetLoaderPage(0);
	this->M_Ticket_UItemLoaderObject->Execute();
}

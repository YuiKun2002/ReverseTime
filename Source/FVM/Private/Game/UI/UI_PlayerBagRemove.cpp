...
UWidget* UUI_PlayerBagRemove::WidgetCreate_InitEquipment(const UItemLoadDataBlock* const _Data, int32 L_Index)
{

	GAME_LOG(__FUNCTION__, TEXT("创建删除的条目"), {
...
void UUI_PlayerBagRemove::WidgetRefresh_UpdateEquipment(const UItemLoadDataBlock* const _Data, int32 L_Index, UWidget* _UWidget)
{
	GAME_LOG(__FUNCTION__, TEXT("刷新删除的条目"), {
		GAME_LOG_LINE(TEXT("需要重写"));
		});
...
UWidget* UUI_PlayerBagRemove::WidgetCreate_InitCards(const UItemLoadDataBlock* const _Data, int32 L_Index)
{
	/*
...
void UUI_PlayerBagRemove::WidgetRefresh_UpdateCards(const UItemLoadDataBlock* const _Data, int32 L_Index, UWidget* _UWidget)
{
	/*
	if (this->M_bUseSerach)
	{
...
void UUI_PlayerBagRemove::InitLoader(uint8 _PanelNumber)
{
	...
	{
	case 1u: {
		this->M_UItemLoaderObject_Cards = NewObject<UItemLoaderObject>(this, TEXT("TimeLoad_Cards_Manager_SearchT"));
		this->M_UItemLoaderObject_Cards->InitWidget_First(this->M_UUniformGridPanel, this->M_UScrollBox, 0.01f);
		this->M_UItemLoaderObject_Cards->InitRange_Second(9, 1, UFVMGameInstance::GetFVMGameInstance()->GetPlayerStructManager()->M_PlayerBagGirdGroup.GetBagCount(_PanelNumber), 700.f, 90.f);
		this->M_UItemLoaderObject_Cards->OnNew.BindUObject(this, &UUI_PlayerBagRemove::WidgetCreate_InitCards);
		this->M_UItemLoaderObject_Cards->OnUpdate.BindUObject(this, &UUI_PlayerBagRemove::WidgetRefresh_UpdateCards);
	}break;
	case 0u:
	case 2u: {
		this->M_UItemLoaderObject_Equipment = NewObject<UItemLoaderObject>(this, TEXT("TimeLoad_Equipment_Manager_SearchT"));
		this->M_UItemLoaderObject_Equipment->InitWidget_First(this->M_UUniformGridPanel, this->M_UScrollBox, 0.01f);
		this->M_UItemLoaderObject_Equipment->InitRange_Second(9, 1, UFVMGameInstance::GetFVMGameInstance()->GetPlayerStructManager()->M_PlayerBagGirdGroup.GetBagCount(_PanelNumber), 700.f, 90.f);
		this->M_UItemLoaderObject_Equipment->OnNew.BindUObject(this, &UUI_PlayerBagRemove::WidgetCreate_InitEquipment);
		this->M_UItemLoaderObject_Equipment->OnUpdate.BindUObject(this, &UUI_PlayerBagRemove::WidgetRefresh_UpdateEquipment);
	}break;
	}
	*/
	//绑定关闭界面
...
*/
	...
	/*
	this->M_UItemLoaderObject_Cards->UpdateDatatable(this->M_FUI_PlayerBagRemove_Item_Index);
	this->M_UItemLoaderObject_Cards->SetLoadItemMaxCount(_SearchMaxCount);
	this->M_UItemLoaderObject_Cards->ContinueRun();
	*/
}
...
void UUI_PlayerBagRemove::SearchBag_Equipment()
{
	...
	GAME_LOG(__FUNCTION__, TEXT("搜索装备栏的所有装备"), {
		GAME_LOG_LINE(TEXT("需要重写"));
		});
	...
	this->M_UItemLoaderObject_Equipment->UpdateDatatable(this->M_FUI_PlayerBagRemove_Item_Index);
	this->M_UItemLoaderObject_Equipment->SetLoadItemMaxCount(_SearchMaxCount);
	this->M_UItemLoaderObject_Equipment->ContinueRun();
...
void UUI_PlayerBagRemove::SearchBag_Materials()
{
	...
	/*
	this->M_UItemLoaderObject_Equipment->UpdateDatatable(this->M_FUI_PlayerBagRemove_Item_Index);
	this->M_UItemLoaderObject_Equipment->SetLoadItemMaxCount(UFVMGameInstance::GetFVMGameInstance()->GetPlayerStructManager()->M_PlayerBagGirdGroup.GetBagCount(2));
	this->M_UItemLoaderObject_Equipment->ContinueRun();
	*/
}
...
void UUI_PlayerBagRemove::SearchBag(uint8 _PanelNumber)
{
	...
	GAME_LOG(__FUNCTION__, TEXT("搜索玩家背包，装备栏还是卡片或者是材料"), {
		GAME_LOG_LINE(TEXT("需要重写"));
		});
	...
	if (_PanelNumber == 0u)
	{
		...
		this->M_UItemLoaderObject_Equipment->UpdateDatatable(this->M_FUI_PlayerBagRemove_Item_Index);
		this->M_UItemLoaderObject_Equipment->SetLoadItemMaxCount(_SearchMaxCount_0);
		this->M_UItemLoaderObject_Equipment->SetResetScrollBoxOffset();
		this->M_UItemLoaderObject_Equipment->ContinueRun();
	}
	...
	if (_PanelNumber == 1u)
	{
		...
		this->M_UItemLoaderObject_Cards->UpdateDatatable(UFVMGameInstance::GetFVMGameInstance()->GetPlayerStructManager()->M_PlayerItems_Card);
		this->M_UItemLoaderObject_Cards->SetLoadItemMaxCount(_SearchMaxCount_1);
		this->M_UItemLoaderObject_Cards->SetResetScrollBoxOffset();
		this->M_UItemLoaderObject_Cards->ContinueRun();
	}
	...
	if (_PanelNumber == 2u)
	{
		...
		this->M_UItemLoaderObject_Equipment->UpdateDatatable(UFVMGameInstance::GetFVMGameInstance()->GetPlayerStructManager()->M_PlayerItems_Material);
		this->M_UItemLoaderObject_Equipment->SetLoadItemMaxCount(_SearchMaxCount_2);
		this->M_UItemLoaderObject_Equipment->SetResetScrollBoxOffset();
		this->M_UItemLoaderObject_Equipment->ContinueRun();
	}
	*/

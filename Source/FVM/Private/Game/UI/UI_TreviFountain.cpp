...
void UUI_TreviFountain::UpdateCoin()
{
	...
	this->M_PlayerCoinType_0 = FString::FromInt(GET_PLAYERDATAINS()->GetCoin(0).CoinValue);
	this->M_PlayerCoinType_2 = FString::FromInt(GET_PLAYERDATAINS()->GetCoin(2).CoinValue);
}
